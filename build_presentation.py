...
2. Embeds available interactive Plotly HTML files inline.
...
def main() -> None:
    ...
    html = template.render(
        ...
        authors="Aleksandra Pawłowska, Karolina Winczewska",
    ...
    print(
        f"Slides: 14  |  Interactive Plotly charts embedded: "
        f"{sum(1 for v in interactive.values() if v is not None)}/{len(INTERACTIVE_FILES)}"
    )
